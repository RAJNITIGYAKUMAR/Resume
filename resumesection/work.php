...
?>
	<div class="text-center">
		...
		<div class="container footer">
			<div>
				<a class="btn btn-primary" href="work.php" role="button">BACK</a>
			</div>
			<div>
				<a class="btn btn-primary" href="skills.php" role="button">SKIP</a>
				<a class="btn btn-primary" href="skills.php" role="button">NEXT</a>
			</div>
